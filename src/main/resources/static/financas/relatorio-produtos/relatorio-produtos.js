/* RELATORIO-PRODUTOS.JS — INTEGRADO COM SPRING BOOT */
...
async function carregarRelatorioDaAPI() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      // FILTRO DE CATEGORIA: Mapeia unicamente os registros de COSMETICO do seu Enum Java
...
async function executarExclusaoConfirmada() {
  ...
  try {
    ...
    mostrarToast("🗑️ Registro(s) de produto(s) excluído(s)!");
