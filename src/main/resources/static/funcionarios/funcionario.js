...
function carregarPerfil() {
  // Usa o valor salvo ou um padrão, sem dar erro
...
function renderizarTabela(lista) {
  ...
  ordenados.forEach(f => {
    ...
    const nomeCargo = f.papel === "ADMIN" ? "Proprietária" : "Funcionária";
...
// 3. ATUALIZA A PESQUISA PARA USAR EMAIL E CARGO
...
async function salvarAtualizacao() {
  ...
  // Se não digitar senha nova, manda essa string para o Java não dar erro no @Valid
...
async function executarExclusaoFunc() {
