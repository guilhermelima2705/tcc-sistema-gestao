    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/funcionario").permitAll() // Permitir cadastro de funcionario, verificar no curso se isso permite que qualquer pessoa crie usuarios
